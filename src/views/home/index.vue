<template>
  <div class="home">
    ...
    <!-- 会员等级3 -->
    <div class="Membership"><p>会员等级：VIP 1</p></div>
...
.headerOut {
  ...
  .fontStyle > span:nth-child(1) {
    letter-spacing: 3px;
  }
  .fontStyle > span:nth-child(2) {
    font-size: 13px;
  }
}
...
.Membership {
  ...
  background-image: linear-gradient(to right, #f7f8f7, #ffdc2e);
  padding-top: 5px;
  padding-bottom: 5px;
  p {
    font-size: 14px;
